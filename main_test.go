...
const (
	fileName                   = "test.json"
	filePermission             = 0644
	expectedErrToBeMsg         = "Expect error to be '%s', but got '%s'"
	expectedOutputToBeMsg      = "Expect output to be '%s', but got '%s'"
	existingItemsSingleElement = "[{\"id\":\"1\",\"email\":\"test@test.com\",\"age\":34}]"
	existingItemsTwoElements   = "[{\"id\":\"1\",\"email\":\"test@test.com\",\"age\":34},{\"id\":\"2\",\"email\":\"test2@test.com\",\"age\":31}]"
)
...
func TestOperationMissingError(t *testing.T) {
	...
	if err.Error() != expectedError {
		t.Errorf(expectedErrToBeMsg, expectedError, err.Error())
	}
}
...
func TestAddingOperationSameID(t *testing.T) {
	...
	existingItem := existingItemsSingleElement
	...
	if resultOutput != expectedOutput {
		t.Errorf(expectedErrToBeMsg, expectedOutput, resultOutput)
	}
}
...
func TestAddingOperation(t *testing.T) {
	...
	expectedFileContent := existingItemsSingleElement
...
func TestFindByIdOperation(t *testing.T) {
	...
	existingItems := existingItemsTwoElements
	...
	if resultString != expectedOutput {
		t.Errorf(expectedOutputToBeMsg, expectedOutput, resultString)
	}
}
...
func TestRemovingOperationWrongID(t *testing.T) {
	...
	existingItems := existingItemsSingleElement
	...
	if resultOutput != expectedOutput {
		t.Errorf(expectedOutputToBeMsg, expectedOutput, resultOutput)
	}
}
